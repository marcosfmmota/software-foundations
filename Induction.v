...
Proof.
  induction n as [|k IHh].
  - reflexivity.
  - simpl. rewrite -> IHh. rewrite -> plus_n_Sm. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  - reflexivity.
  - rewrite -> IHk. rewrite -> negb_involutive. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  - rewrite -> mult_0_r. rewrite -> mult_0_l. reflexivity.
  - simpl. rewrite <- mult_n_Sm. rewrite -> IHm'. rewrite -> plus_comm. reflexivity.
Qed.
(** [] *)
